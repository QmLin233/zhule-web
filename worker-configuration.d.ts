/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 98b41159065bd02d7d9ab1b13f94e393)
...
declare namespace Cloudflare {
	...
	interface Env {
		FILES: R2Bucket;
		DB: D1Database;
		PUBLIC_BUCKET_URL: "https://cdn.zhule.org";
		ADMIN: string;
		ADMIN_PASSWD: string;
		AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BUCKET_URL" | "ADMIN" | "ADMIN_PASSWD" | "AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
